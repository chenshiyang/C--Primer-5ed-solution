#ifndef TEST19_19_SALES_DATA_H
#define TEST19_19_SALES_DATA_H
#include<iostream>
#include<string>
////declaration for friend class declaration
//
...
class Sales_data {
    ...
    friend bool operator!=(const Sales_data&, const Sales_data&);
    //required by test 19.19
    friend bool higher_than(const Sales_data&, double);
